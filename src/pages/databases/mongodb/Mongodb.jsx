  ...
  return (
    <section>
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          Graph: menyimpan data dalam node dan edge. Node menyimpan info tentang orang, tempat dan apapun itu. Edge meyimpan
          info tentang hubungan masing masing node. Db jenis ini digunakan untuk menyimpan data model jaringan, fraud
          detection dan machine learning. Contohnya Neo4j dan JanusGraph
        </li>
        <li>
      ...
      <H2>CRUD Mongodb / Mongodb Commands</H2>
      <ul className="list-inside list-disc">
...
new_db> db.products.deleteMany()`}</Pre>
        <li>
          Authentication adalah mekanisme keamanan untuk membatasi hak akses pada db. Secara default kita masuk mongosh tanpa
          otentikasi, untuk aktifkan auth, kita harus tambahkan security pada konfigurasi mongo kita, caranya: cari file
          konfigurasi yakni tempat mongodb diunduh C:\Program Files\MongoDB\Server\6.0\bin, buka file mongod.cfg atau
